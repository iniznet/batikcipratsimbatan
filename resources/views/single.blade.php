...
@section('content')
  ...
  <section class="relative pb-40 overflow-hidden">
    <x-container>
      ...
      <div class="prose prose-neutral bg-[#f5f7fd] p-8 shadow-lg rounded-tl-3xl rounded-br-3xl [&>p>img]:max-h-96 [&>p>img]:w-auto [&>p>img]:float-left [&>p>img]:m-4 [&>p>img]:ml-0 [&>p>img]:rounded-xl">
